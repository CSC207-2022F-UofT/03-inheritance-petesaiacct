 ...
 */
    ...
    /**
     * creates a new CrossbodyBag with an additional parameter for straps
     *
     *
     * @param color
     * @param capacity
    ...
    public String toString() {
        return getColor() + " Crossbody Bag with "+ this.getNumberOfStraps() + " straps (" + getNumberOfContents() + " / " +
                getCapacity() + ")";
    }
}